//Generated:2023-01-27 20:14:55// 6-273
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4231132 || '',
    guid: window.ftGUID_4231132 || '',
    confID: window.ftConfID_4231132 || '0',
    ftReturn: window.ftReturn_4231132 || '',
    keyword: window.ftKeyword_4231132 || '',
    ftId: window.ftId_4231132 || '',
    ftImpId: window.ftImp4231132 && window.ftImp4231132.impID || '',
    gdpr: window.ftImp4231132 && window.ftImp4231132.gdpr || '',
    gdpr_consent: window.ftImp4231132 && window.ftImp4231132.gdpr_consent || '',
    gdpr_pd: window.ftImp4231132 && window.ftImp4231132.gdpr_pd || '',
    us_privacy: window.ftImp4231132 && window.ftImp4231132.us_privacy || '',
    campaignID: '115845',
    cID: '155979',
    pID: '4231132',
    creativeID: '4112630',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115845&sid=18330&plc=4231132&num=&adid=&advid=&adsrv=29&btreg=4231132&btadsrv=flashtalking&crt=4112630&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115845;4231132;4112630;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/it/creativecloud/plans.html?plan=individual&locale=it&sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224892385-4231132;4112630;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/423/4231132/4112630/image/4112630.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115845;4231132;202;pixel;DV360;DV360FY20CCLALCLTV80100ITDSKBAN300x250/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115845;4231132;4112630;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/it/creativecloud/plans.html?plan=individual&locale=it&sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv4231132',
    altimgID: 'ftalt4231132',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4231132 && parseInt(window.ftImp4231132.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4231132') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4231132'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4231132").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4231132").style.display = "none";
		    }
		});
	}
}(ft4231132));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115845&l2=DV360&l3=4231132&l4=4112630&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115845&l2=DV360&l3=4231132&l4=4112630&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4231132;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4231132;
